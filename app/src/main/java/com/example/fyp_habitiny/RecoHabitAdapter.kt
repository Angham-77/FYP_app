...
class RecoHabitAdapter (context: Context, resource: Int, private val habitList: List<RecoHabit>, private val listener: RecoHabitClickListener) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val itemView = inflater.inflate(
            R.layout.activity_single_recohabit,
            parent,
            false
        )
