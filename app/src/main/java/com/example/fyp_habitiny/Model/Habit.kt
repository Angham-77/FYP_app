...
data class Habit  (val habitId: Int, var HabitUserId: Int, var habitName: String, var habitStartDate: String,
                   val habitStatus: Int, val habittarget: Int, val habittimePreference: String, var habitcurrentCount: Int, val habitEndtDate: String ) {
    ...
    constructor(cursor: Cursor) : this(
        ...
        habitEndtDate = cursor.getString(cursor.getColumnIndexOrThrow("EndDate")),
